# HQ — Soulfold's headquarters

Everything about *how this project is run* lives here. The code lives in the
package directories (`cmd/`, `internal/`); everything else — why Soulfold
exists, what we're investigating, what we've designed, what we're building,
and what happened — lives in one of the areas below.
...
| [`02-DESIGN/`](02-DESIGN/README.md) | The normative design of the fold and its surfaces | When research graduates, or a build changes behavior |
...
- Designs in `02-DESIGN/` are written functional-level: capability, seams,
  ...
  without guessing. Decisions carry numbers with their reasoning so they can
